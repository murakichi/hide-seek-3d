...
//
// 仮説: 逃げる側が拠点を作るために箱をロックする行為が、鬼の lockedBoxLure に
// よってそのまま「居場所シグナル」に変換されている。隠れ家を作るほど見つかりやすい。
//
//   npx tsx src/sim/_probe.ts where          発見地点がロック箱にどれだけ寄っているか
//   npx tsx src/sim/_probe.ts sweep 1 1      lockedBoxLure を振って勝率を見る
